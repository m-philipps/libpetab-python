...
SIMULATION_DF_REQUIRED_COLS = MEASUREMENT_DF_REQUIRED_COLS.copy()
SIMULATION_DF_REQUIRED_COLS[2] = SIMULATION

SIMULATION_DF_OPTIONAL_COLS = MEASUREMENT_DF_OPTIONAL_COLS.copy()

SIMULATION_DF_COLS = MEASUREMENT_DF_COLS.copy()
SIMULATION_DF_COLS[3] = SIMULATION
